	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse col" id="navbarSupportedContent">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item"><a class="nav-link" href="#">주변정보</a></li>
			</ul>
			<%
				if (userId == null) {
			%>
					...
					<form action="modify.co" method="post">
						...
						<tr>
							...
							<td><input type="text" name="bTitle"
								value="${content_view.bTitle}" size="100%"></td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea class="txt_area" rows="10" name="bContent"
									style="height: 100%; width: 100%"> ${content_view.bContent}</textarea></td>
						</tr>
						<tr>
							<td colspan="2">
								<button type="submit" class="btnGoModify">수정</button>&nbsp;&nbsp;
								<input type="button" value="목록보기"
								onclick="window.location='list.co'">&nbsp;&nbsp;
							</td>
						</tr>
					</form>
				</table>
