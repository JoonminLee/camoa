...
<center>
<% %>
<form action="deletePro.do?cf_num=${cf_num }&pageNum=${pageNum }" method="post" onsubmit="return deleteSave()" name="delForm">
			<input type="submit" value="삭제">
			<input type = "button" value ="돌아가기" onclick="document.location.href='list.do?pageNum=${ pageNum }'"></td>
</form>
</center>
   </div>
</body>
