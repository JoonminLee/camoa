	...
	<form action = "writePro.do" method="post" name="writeform" onsubmit="return writeSave()">
		...
		<table width='500' border='1' cellspacing='1' cellpadding='0' align="center">
			<tr>
				...
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_id" value="${userId }" readonly="readonly"></td>
			</tr>
			<tr>
				<td width="100" align="center">카페명</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_name"></td>
			</tr>
			<tr>
				<td width="100" align="center">카페위치</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_address"></td>
			</tr>
			
			<tr>
				<td width="100" align="center">카페연락처</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_phone"></td>
			</tr>
			<tr>
				<td width="100" align="center">아메리카노 가격</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_ame"></td>
			</tr>
			<tr>
				<td width="100" align="center">카페라떼 가격</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_latte"></td>
			</tr>
			<tr>
				<td width="100" align="center">카라멜마끼아또 가격</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_caramel"></td>
			</tr>
			<tr>
				<td width="100" align="center">카페모카 가격</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_mocha"></td>
			</tr>
			<tr>
				<td width="100" align="center">바닐라라떼 가격</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_vanila"></td>
			</tr>
			<tr>
				<td width="100" align="center">영업시간</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_workhour"></td>
			</tr>
			<tr>
				<td width="100" align="center">주차정보</td>
				<td width="400">&nbsp;&nbsp;<input type="text" size = "40" maxlength="50" name = "cf_park"></td>
			</tr>
			<tr>
				<td width="100" align="center">카페소개</td>
				<td width="400">&nbsp;&nbsp;<textarea rows="20" cols="40" name="cf_intro"></textarea></td>
			</tr>
			<tr>
